...
public class UserErrorStatisticRepository : IUserErrorStatisticRepository
{
    ...
    public async Task<UserErrorStatistic?> GetAsync(Guid userId, int criteriaId, int partId, int levelId)
    {
    ...
    public async Task<UserErrorStatistic> IncrementErrorCountAsync(Guid userId, int criteriaId, int partId, int levelId)
    {
