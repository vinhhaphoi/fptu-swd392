      ...
      <div className="relative z-10 w-full max-w-[440px] animate-in fade-in zoom-in duration-500">
        ...
        <div className="flex justify-center mb-10">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Main Login Card */}
        <div className="bg-card/40 backdrop-blur-2xl border border-card-border rounded-[32px] p-8 sm:p-10 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              ...
              size="lg"
              loading={loading}
              className="py-4 text-base font-bold shadow-xl"
            >
              Sign In
              <ArrowRight
                size={18}
