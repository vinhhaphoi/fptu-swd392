  ...
  return (
    <div className="min-h-screen py-12 bg-background">
      <div className="max-w-4xl mx-auto px-4">
        {/* Profile Header */}
        <div className="bg-card/50 backdrop-blur-xl border border-card-border rounded-[32px] p-8 mb-8 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
                ...
                <div key={skill} className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-xl bg-gradient-to-br ${data.color} flex items-center justify-center text-xl shadow-lg`}
                      >
                        {data.icon}
                      </div>
