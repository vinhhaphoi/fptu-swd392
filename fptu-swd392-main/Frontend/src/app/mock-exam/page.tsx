    ...
    return (
      <div className="min-h-screen py-20 bg-background">
        <div className="max-w-md mx-auto px-4 text-center">
          <div className="bg-card border border-card-border rounded-[32px] p-8 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
  ...
  return (
    <div className="min-h-screen py-12 bg-background">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Level Selection */}
        <div className="bg-card border border-card-border rounded-[32px] p-8 mb-8 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
        ...
        <div className="text-center">
          <Button
            ...
            loading={isStarting}
            className="px-16 py-8 text-xl h-auto rounded-2xl shadow-xl"
          >
