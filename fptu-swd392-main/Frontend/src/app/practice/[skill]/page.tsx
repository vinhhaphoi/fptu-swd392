...
import GradientTimeline, { mockGradientTimelineData } from "@/components/GradientTimeline";
import MultipleTimelineProgress, { mockMultipleTimelineData } from "@/components/MultipleTimelineProgress";
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <GradientTimeline
          steps={mockGradientTimelineData}
          currentStepIndex={2}
          showLabels={false}
        />
        <MultipleTimelineProgress timelines={mockMultipleTimelineData} />

        {contentLoading || testsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tests.map((test) => (
              <Link
                ...
                className="group bg-card border border-card-border rounded-xl p-6 hover:border-indigo-500/20 hover:shadow-xl transition-all duration-300"
              >
