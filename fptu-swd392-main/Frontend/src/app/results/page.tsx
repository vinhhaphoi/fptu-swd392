    ...
    return (
      <div className="min-h-screen py-20 bg-background">
        <div className="max-w-md mx-auto px-4 text-center">
          <div className="bg-card rounded-[32px] p-8 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          {[
            ...
            <div
              key={i}
              className="bg-card rounded-3xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)]"
            >
              <div
        ...
        <div className="bg-card border border-card-border rounded-[32px] p-8 mb-10 shadow-xl">
        ...
        <div>
          ...
          {results.length === 0 ? (
            <div className="bg-card border border-card-border rounded-[40px] p-16 text-center shadow-xl">
            ...
            <div className="space-y-4">
              {results.map((result) => {
                ...
                return (
                  <div
                    key={result.id}
                    className="bg-card rounded-2xl p-6 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_1px_2px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-all group hover:scale-[1.01]"
                  >
